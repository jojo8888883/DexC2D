        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    print("成功启动无配置文件的Chrome")
                except Exception as e2:
                    print(f"启动Chrome失败: {e2}")
                    return False
            ...
            print("查找Create按钮...")
            try:
                create_button = await page.wait_for_selector("text=Create", timeout=5000)
                print("找到Create按钮，点击进入创建页面")
                await create_button.click()
                await page.wait_for_load_state("networkidle")
            except Exception as e:
                print(f"无法找到或点击Create按钮: {e}")
                print("尝试直接导航到create页面...")
